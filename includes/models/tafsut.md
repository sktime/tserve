...
<span class="tserve-meta-item">:material-function-variant: [`TafsutForecaster`](https://www.sktime.net/docs/api-reference/sktimeforecastingtafsuttafsutforecaster/)</span>
<span class="tserve-meta-item">:material-package-variant: extra [`tafsut`](tafsut.md)</span>
...
| model | checkpoint |
| --- | --- |
| `tafsut` | [Tafsut-FM/tafsut-univariate-base](https://huggingface.co/Tafsut-FM/tafsut-univariate-base) |
