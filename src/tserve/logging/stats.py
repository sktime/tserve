"""In-memory, thread-safe metrics for loaded TServe models.

TServe is a time-series foundation-model inference server. ``Stats`` is
...
(``tserve.types.converters``) or sktime converters
