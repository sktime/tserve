...
not an exception class. TServe has no custom exception hierarchy.
...
from tserve.types._checks import _check_frame, _require_columns
from tserve.types._examples import (
    HEALTH_OK,
    MODELS_RESULT,
    PREDICT_REQUEST,
    PREDICT_RESULT,
