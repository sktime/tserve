"""Python client for a running TServe inference server.

Import ``Client`` from ``tserve.client``. Tables keep the type you send
...
class Client:
    ...
    The client connects to a local TServe server. Use it as a context
